            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                <label class="col-form-label">Jenis Karyawan<small class="text-danger">*</small></label>
                        ...
                        <div class="col-12">
                            <div class="mb-1">
                                <label class="col-form-label">Foto<small class="text-danger">*</small></label>
                                <input type="file" class="form-control" name="employee_photo_path" accept="image/*">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-1">
                    ...
                    <table class="table table-bordered" style="width: 100%">
                        ...
                        <?php foreach ($employees as $i => $employee) { ?>
                            <tr>
                                ...
                                <td><?= esc($employee->employee_type) ?></td>
                                ...
                                <td class="text-center">
                                    <?php if ($employee->employee_photo_path) { ?>
                                        <div class="avatar-wrapper">
                                            <div class="avatar avatar-lg">
                                                <img src="<?= base_url(esc($employee->employee_photo_path)) ?>"
                                                     alt="Avatar"
                                ...
                                <td class="text-center">
                                    ...
                                    <button onclick="setFormEdit('<?= $employee->employee_name ?>', '<?= $employee->employee_phone ?>', <?= $employee->employee_status ?>, '<?= $employee->employee_id ?>', '<?= $employee->employee_type ?>')"
...
<script>
    function setFormEdit(name, hp, status, id, employee_type) {
        ...
        $("#formEmployee select[name=employee_type]").val(employee_type)
        if (status === 1)
