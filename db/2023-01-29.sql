...
-- Dumping data for table pos-penjahit.customer: ~4 rows (approximately)
...
-- Dumping data for table pos-penjahit.employee: ~4 rows (approximately)
...
INSERT INTO `employee` (`employee_id`, `employee_name`, `employee_phone`, `employee_type`, `employee_status`, `employee_photo_path`) VALUES
	...
	(9, 'Utuh', '089532037565', 'Tetap', b'1', 'data/img/employee/1674974792_06a59dffb7d3c16010f2.jpg');
...
-- Dumping data for table pos-penjahit.ledger: ~3 rows (approximately)
DELETE FROM `ledger`;
...
-- Dumping data for table pos-penjahit.menu: ~12 rows (approximately)
DELETE FROM `menu`;
...
-- Dumping data for table pos-penjahit.menu_role: ~12 rows (approximately)
...
-- Dumping data for table pos-penjahit.transaction: ~3 rows (approximately)
...
-- Dumping data for table pos-penjahit.transaction_detail: ~3 rows (approximately)
...
-- Dumping data for table pos-penjahit.transaction_spending: ~2 rows (approximately)
...
INSERT INTO `transaction_spending` (`spending_id`, `employee_id`, `supplier_id`, `spending_date`, `spending_desc`, `spending_total`, `spending_photo_path`, `is_ledger`, `created_at`, `updated_at`) VALUES
	(4, 1, 0, '2022-12-20', 'Pembayaran Honor Penjahit', 125000, 'data/img/pengeluaran/1674963267_317a1a147f68fd189619.jpg', b'0', '2022-12-20 09:08:34', '2023-01-29 14:46:56'),
	(7, 9, 0, '2023-01-29', 'kewjfbkebfr', 20000, 'data/img/pengeluaran/1674963604_a22787ac08f0feb19c3d.jpeg', b'0', '2023-01-29 11:40:04', '2023-01-29 14:46:59'),
	(8, 1, 0, '2023-01-29', 'ewkjfkewfn', 12000, 'data/img/pengeluaran/1674974898_6caea56166ed0b283857.jpeg', b'0', '2023-01-29 14:48:18', '2023-01-29 14:48:18');
...
-- Dumping data for table pos-penjahit.user: ~2 rows (approximately)
DELETE FROM `user`;
