...
-- Dumping data for table pos-penjahit.account: ~19 rows (approximately)
INSERT IGNORE INTO `account` (`account_code`, `account_name`, `uti_account_post_id`, `uti_account_group_id`) VALUES
	(112, 'BRI', 1, 1),
	(113, 'Bunga Bank', 1, 1),
	(211, 'Hutang', 2, 1),
	(311, 'Modal', 2, 1),
...
-- Dumping data for table pos-penjahit.ledger: ~5 rows (approximately)
INSERT IGNORE INTO `ledger` (`ledger_id`, `account_code`, `transaction_code`, `spending_id`, `ledger_name`, `ledger_desc`, `ledger_number`, `ledger_date`, `ledger_score`, `created_at`, `updated_at`) VALUES
	(1, 112, NULL, NULL, NULL, 'Saldo Awal', 1, '2022-12-11', 100000000, NULL, NULL),
	(3, 512, '1E793FC5043AE8814665', NULL, NULL, 'asda as das dasdasd', 2, '2022-12-11', 320000, NULL, NULL),
	(7, 211, NULL, NULL, NULL, 'Bayar Hutang', 6, '2022-12-11', 2000000, NULL, NULL),
	(8, 211, NULL, NULL, NULL, 'Bayar Hutang', 4, '2022-12-11', 10000000, NULL, NULL),
	(9, 512, '2C6C6AA43C21D883ACC6', NULL, NULL, 'sdasd asdasd', 5, '2022-12-11', 805000, NULL, NULL),
	(10, 512, '2C47F73583940BF83817', NULL, NULL, 'asdasd as dasdas', 6, '2022-12-11', 240000, NULL, NULL),
	(13, 511, '53C74BC6EC30FA2FBA85', NULL, 'Yamano', 'ad adsasd asd asdasd', 7, '2022-12-11', 260000, NULL, NULL),
	(15, 411, NULL, 2, '', ' ascascams am cams amsd a', 8, '2022-12-11', 43200000, NULL, NULL);
...
INSERT IGNORE INTO `transaction` (`transaction_code`, `employee_id`, `customer_phone`, `transaction_date`, `transaction_desc`, `is_ledger`, `created_at`, `updated_at`) VALUES
	('1E793FC5043AE8814665', 1, '123', '2022-12-08', 'asda as das dasdasd', b'1', NULL, '2022-12-11 04:51:00'),
	('2C47F73583940BF83817', 2, 'dadasda', '2022-12-08', 'asdasd as dasdas', b'1', NULL, '2022-12-11 06:28:29'),
	('2C6C6AA43C21D883ACC6', 1, '123', '2022-12-01', 'sdasd asdasd', b'1', NULL, '2022-12-11 06:26:42'),
	('53C74BC6EC30FA2FBA85', 1, '12345', '2022-12-08', 'ad adsasd asd asdasd', b'1', NULL, '2022-12-11 06:31:10'),
...
-- Dumping data for table pos-penjahit.transaction_detail: ~7 rows (approximately)
INSERT IGNORE INTO `transaction_detail` (`transaction_detail_id`, `transaction_code`, `product_id`, `product_name`, `category_name`, `product_unit`, `transaction_detail_discount`, `transaction_detail_price`, `transaction_detail_quantity`, `transaction_detail_total`, `created_at`, `updated_at`) VALUES
	...
	(12, '2C6C6AA43C21D883ACC6', 2, 'Stola Lengkung', 'Retail', 'Set', 0, 90000, 2, 180000, NULL, NULL),
	(13, '2C6C6AA43C21D883ACC6', 3, 'Jubah Pendeta', 'Jasa', 'Set', 0, 625000, 1, 625000, NULL, NULL);
...
INSERT IGNORE INTO `transaction_spending` (`spending_id`, `employee_id`, `supplier_id`, `spending_date`, `spending_desc`, `spending_total`, `is_ledger`, `created_at`, `updated_at`) VALUES
	(1, 1, NULL, '2022-12-11', 'asdjkan abs asdbab', 2000000, b'0', NULL, NULL),
	(2, 3, NULL, '2022-12-11', ' ascascams am cams amsd a', 43200000, b'1', '2022-12-11 06:33:23', '2022-12-11 06:46:18');
...
INSERT IGNORE INTO `uti_account_group` (`uti_account_group_id`, `uti_account_group_name`, `uti_account_group_alias`) VALUES
	(1, 'Neraca', 'NRC'),
	(2, 'Laba Rugi', 'L/R');
